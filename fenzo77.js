...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./media/image/mans.jpg'), 2022, "Baby Bot", "6283155687629@s.whatsapp.net", "AR7zJt8MasFx2Uir/fdxhkhPGDbswfWrAr2gmoyqNZ/0Wg==", "99999999999999999999")
}
...
let butRun = [
        	...
        	mans.sendMessage(m.chat, { caption: listmn, document: { url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.xlsx' }, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: '© Babybot By Aldi STORE', templateButtons: butRun, footer: `🌏 Dont Spam & Telpon Bot`, mentionedJid: [m.sender] })
        	break
...
case 'me': case 'inventori': case 'profile':{
  ...
  if (!isInventoriBuruan){ addInventoriBuruan(m.sender) }
     ...
     let butRun = [
        	...
        	mans.sendMessage(m.chat, { caption: teksehmazeh, document: { url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx' }, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: '© Aldi Store', templateButtons: butRun, footer: `ingin Berpetualang Lagi`, mentions: [m.sender] })
        	}
        	break
...
hydratedFooterText: "© Baby Bot - X - Baby Bot",
hydratedButtons: [{
urlButton: {
...
mans.sendMessage(from, {image:{url:qris}, caption: toppp}, {quoted:ftoko})
}
break
case 'rekber':{
...
mans.sendMessage(from, {image:{url:qris}, caption: topp}, {quoted:ftoko})
}
break
case 'list-joki':{
let top = `
𝙅𝘼𝙎𝘼 𝙅𝙊𝙆𝙄 *Aldi STORE*
...
⬇️𝗣𝗔𝗞𝗘𝗧 𝗣𝗢𝗜𝗡⬇️
🔹 𝗠𝗬𝗧𝗛𝗖𝗞 𝗩 - 𝗚𝗟𝗢𝗥𝗬 = 𝟯𝟱𝟬𝗞
🔹 𝗠𝗬𝗧𝗛𝗖𝗞 𝗜𝗩 - 𝗚𝗟𝗢𝗥𝗬 = 𝟯𝟮𝟰𝗞
🔹 𝗠𝗬𝗧𝗛𝗖𝗞 𝗜𝗜𝗜 - 𝗚𝗟𝗢𝗥𝗬 = 𝟮𝟲𝟬𝗞
🔹𝗠𝗬𝗧𝗛𝗖𝗞 𝗜𝗜 - 𝗚𝗟𝗢𝗥𝗬 = 𝟮𝟬𝟬𝗞
🔹 𝗠𝗬𝗧𝗛𝗖𝗞 𝗜 - =𝗚𝗟𝗢𝗥𝗬 = 𝟵𝟬𝗞
🔹𝗚𝗟𝗢𝗥𝗬 𝟲𝟬𝟬 - 𝗚𝗟𝗢𝗥𝗬 𝟭𝗞 = 𝟱𝟭𝟰𝗞
...
⬇️𝗣𝗔𝗞𝗘𝗧 𝗥𝗔𝗡𝗞 𝗠𝗠𝗥⬇️
🎮 𝗠𝗬𝗧𝗛𝗖𝗞 𝗩 - 𝗚𝗟𝗢𝗥𝗬 = 𝟯𝟲𝟭𝗞
🎮 𝗠𝗬𝗧𝗛𝗖𝗞 𝗜𝗩 - 𝗚𝗟𝗢𝗥𝗬 = 𝟯𝟯𝟰𝗞
🎮 𝗠𝗬𝗧𝗛𝗖𝗞 𝗜𝗜𝗜 - 𝗚𝗟𝗢𝗥𝗬 = 𝟮𝟴𝟱𝗞
🎮 𝗠𝗬𝗧𝗛𝗖𝗞 𝗜𝗜 - 𝗚𝗟𝗢𝗥𝗬 = 𝟮𝟭𝟬𝗞
🎮 𝗠𝗬𝗧𝗛𝗖𝗞 𝗜 - 𝗚𝗟𝗢𝗥𝗬 = 𝟭𝟬𝟱𝗞
🎮 𝗚𝗟`
mans.sendMessage(from, {image:{url:qris}, caption: top}, {quoted:ftoko})
}
break
...
case 'quotesimage':case 'qoutesimage':
				   ...
				   fakey(mess.wait)
				  mans.sendMessage(m.chat, { image: { url: cok }, caption: 'Done' }, { quoted: m })
				  break
...
sendOrder(m.chat, teks, "5123658817728409", fs.readFileSync('./media/image/mans.jpg'), 2022, "Baby Bot", "6283155687629@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 50) {
await mans.groupAcceptInvite(vcc).then(async(res) => m.reply(jsonformat(res))).catch(_ => _)
m.reply("Succes")
} else {
...
mans.setStatus(`Mode : Public Created By Aldi Store`)
}
break
case 'setstatut':
case 'setbio':
...
mans.setStatus(`Mode : Self Created By Aldi Store`)
}
break
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Baby Bot - Twitter Downloader",
...
headerType: 4,
contextInfo:{externalAdReply:{
title:"Baby Bot - Facebook Downloader",
...
case 'iqra': {
		...
		mans.sendMessage(m.chat, {document: yy, mimetype: 'application/pdf', fileName: `iqra${text}.pdf By Aldi Store`}, {quoted:m}).catch ((err) => m.reply(oh))
		}
		break
		case 'juzamma': {
		if (args[0] === 'pdf') {
...
mans.sendMessage(from, {video:{url:buffer}, mimetype:"video/mp4", caption:"By Aldi Store"}, {quoted:m})
break
case 'asupan-santuy':
case 'asupansantuy':
 fakey(mess.wait)
...
teks = tes.result
buffer = `https://telegra.ph/file/61e4db12aadcc07725602.jpg`
mans.sendMessage(from, {image:{url:buffer}, caption:teks}, {quoted:m})
break
case 'quotes':
...
.then((a) => {
      ...
      mans.sendMessage(from, { video: { url: dl_link }, caption: "By Aldi Store" }, { quoted: m })
      })
...
kisah = await fetchJson(`https://api.dapuhy.xyz/api/islam/kisahnabi?nabi=${q}&apikey=0gly81wDky`)
nabii = `Nama : ${kisah.name}
